...
{
  DEBUG_LINK_SET("--- LINK SET ---");
  DEBUG_LINK_SET("");

  DEBUG_INC;

  DEBUG_LINK_SET("current time is %d", (int)olsr_get_current_time());
  DEBUG_LINK_SET("");

  DEBUG_LINK_SET(".-%s-.-%s-.-%s-.-%s-.-%s-.",
                 DASHES(11),
                 DASHES(11),
                 DASHES(10),
                 DASHES(10),
  ...
  DEBUG_LINK_SET("| %11s | %11s | %10s | %10s | %10s |",
  ...
  FOREACH_LINK_CREW(
    l,
    DEBUG_LINK_SET("| %11d | %11d | %10d | %10d | %10d |",
